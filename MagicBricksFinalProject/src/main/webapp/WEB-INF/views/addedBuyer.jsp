...
New Buyer User Created Successfully:<span style="font-size: 50px;color: white"> ${buyer.user.userName}</span></td></tr>
<tr><td>
<a href="login.htm"><span style="font-size: 50px;text-align: center">Sign in</span></a></td></tr>
</table>
</div>
</body>
</html>