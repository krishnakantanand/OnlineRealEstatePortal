...
<tr>
    ...
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="black"><form:input path="user.userName" size="30" /> </font></td>
...
<td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;">Password:</td>
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="black"><form:password path="user.password" size="30" /></font> </td>
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="red"> <form:errors path="user.password"/></font></td>
</tr>
<tr>
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;">First Name:</td>
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="black"><form:input path="user.firstName" size="30" /> </font></td>
...
<tr>
    ...
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="black"><form:input path="user.lastName" size="30" /></font> </td>
...
<tr>
    ...
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="black"><form:input path="user.emailID" size="30" /></font> </td>
...
<tr>
    ...
    <td style="text-align:center;font-size: 15px;font-family: 'Exo', sans-serif;"><font color="black"><form:input path="user.phoneNumber" size="30" /></font> </td>
    <td><font color="red"> <form:errors path="user.phoneNumber"/></font></td>
</tr>
<tr>
    <td colspan="2" style="text-align:center;font-size: 35px;font-family: 'Exo', sans-serif;"><font color="black"><input type="submit" value="Create Seller" /></font></td>
</tr>
</table>
</div>
</form:form>
