...
<tr>
    <td style="text-align:center;font-size: 20px;font-family: 'Exo', sans-serif;">Location:</td>
    <td style="text-align:center;font-size: 20px;font-family: 'Exo', sans-serif;"><font color="black"><input type="text" path="location" name="location" size="30" /></font></td>
    <td style="text-align:center;font-size: 20px;font-family: 'Exo', sans-serif;"><font color="red"> <form:errors path="location"/></font></td>
</tr>
<tr>
    <td style="text-align:center;font-size: 20px;font-family: 'Exo', sans-serif;" colspan="2"><font color="black"><input type="submit" value="Search Properties" /></font></td>
</tr>
</table>  
